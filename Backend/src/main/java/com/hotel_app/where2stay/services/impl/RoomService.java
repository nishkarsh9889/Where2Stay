...
public class RoomService implements IRoomService {
    ...
    public Response addNewRoom(MultipartFile photo, String roomType, BigDecimal roomPrice, String description) {
        ...
        try {
            ...
            String fileUrl = "https://where2stay-production.up.railway.app/Backend/images/" + fileName;
    ...
    public Response updateRoom(Long roomId, String description, String roomType, BigDecimal roomPrice,
        ...
        try {
            ...
            if (photo != null && !photo.isEmpty()) {
                ...
                imageUrl = "https://where2stay-production.up.railway.app/Backend/images/" + fileName;
            }
