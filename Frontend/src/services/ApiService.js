...
export default class ApiService {
    ...
    static BASE_URL = "https://where2stay-production.up.railway.app"
    ...
    static async createStripeSession(bookings) {
        const response = await axios.post(`${this.BASE_URL}/payment/create-session`, bookings, {
